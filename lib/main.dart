...
import 'package:test_things/home.dart';
import 'package:test_things/router/app_router.dart';
import 'package:test_things/router/router_material_app.dart';
...
void main() {
  runApp(
    DevicePreview(
      ...
      builder: (context) => ShellRouteExampleApp() /*const MyApp()*/,
    ),
  );
}
